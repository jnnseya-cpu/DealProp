...
import { STANDARD_MILESTONES, type Milestone, type MilestoneStatus } from "@/domain/completion";
...
export async function seed(): Promise<void> {
  ...
  await replaceAll({ deals: DEALS, buyBoxes: BUY_BOXES, fundingBoxes: FUNDING_BOXES, subscribers: [], accounts: [], auditEvents: [] });
}
